...
export async function loadIssuedDigitalSettlementInstruction(publicId: string) {
  ...
  return {
    ...
    counterpartyRepresentative: settlement.counterpartyRepresentative,
    ...
    proceduralBasis: settlement.proceduralBasis,
    ...
    spotPricePerKgUsd: settlement.spotPricePerKgUsd?.toString() ?? null,
    pricePerKgUsd: settlement.pricePerKgUsd?.toString() ?? null,
    transactionValueUsd: settlement.transactionValueUsd?.toString() ?? null,
    settlementPercentage: settlement.settlementPercentage.toString(),
    settlementAmountUsd: settlement.settlementAmountUsd?.toString() ?? null,
