...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "user" | "revokedToken" | "session" | "account" | "verificationToken"
    ...
    model: {
      ...
      RevokedToken: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.RevokedTokenFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.RevokedTokenAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "createdAt" | "updatedAt" | "name" | "email" | "password" | "role" | "encryptedPrivateKey" | "iv" | "isAdmin" | "walletAddress" | "walletBalance" | "industry" | "interests", ExtArgs["result"]["user"]>
  ...
  export type RevokedTokenOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "jti" | "expiresAt", ExtArgs["result"]["revokedToken"]>
  ...
  export interface RevokedTokenDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more RevokedTokens that matches the filter.
     * @param {RevokedTokenFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const revokedToken = await prisma.revokedToken.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: RevokedTokenFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a RevokedToken.
     * @param {RevokedTokenAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const revokedToken = await prisma.revokedToken.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: RevokedTokenAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  /**
   * RevokedToken findRaw
   */
  export type RevokedTokenFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * RevokedToken aggregateRaw
   */
  export type RevokedTokenAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    iv?: StringWithAggregatesFilter<"User"> | string
  ...
  export type VerificationTokenWhereUniqueInput = Prisma.AtLeast<{
    ...
    NOT?: VerificationTokenWhereInput | VerificationTokenWhereInput[]
    expires?: DateTimeFilter<"VerificationToken"> | Date | string
  }, "id" | "identifier" | "token" | "identifier_token">
