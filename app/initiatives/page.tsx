...
// Local formatter (keeps things consistent without pulling extra utils)
...
export default async function InitiativesPublicListPage() {
  ...
  // 2) Fetch pledged totals in ONE query and map by initiativeId
    ...
    <main className="min-h-screen bg-black text-white">
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <p className="text-sm text-zinc-400 mt-1">
          Explore current programs and their impact.
        </p>
