...
export interface TokenRowProps {
  token: TokenPayload & {
    tokenString?: string; // optional raw string if available
    qrPath?: string;      // optional QR path
  };
}
    ...
    <div className={styles.tokenRowContainer}>
      <div className={styles.tokenRow}>
        ...
        <div className={styles.tokenRowItem}>
          ...
          <span className={styles.tokenRowValue}>{new Date(token.iat * 1000).toLocaleString()}</span>
        </div>
