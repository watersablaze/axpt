        ...
        <div className="w-full md:w-[48%] mt-60">
          ...
          <div className="bg-purple-900 bg-opacity-30 text-purple-100 border border-purple-700 rounded-xl p-6 shadow-lg">
            ...
            <p className="text-sm text-purple-200">
              The gateway is not yet open, but you’re right where you need to be. Soon you will invited to grow from Token-Bearer to Key-Holder as a full AXPT.io account holder and engage the ecosytem.
            </p>
