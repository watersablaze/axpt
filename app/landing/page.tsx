        ...
        <main className={styles.landingContainer}>
            ...
            <section className={styles.hero}>
                ...
                <div className={styles.leftSideText}>
                  {/* ✅ Updated Blockchain Icon with Golden Color */}
                  <motion.div 
                  ...
                  >
                    ...
                    <motion.p className={styles.fadeInText}
              ...
              <div className={styles.rightSideText}>
                  <motion.p className={`${styles.revealText} ${styles.goldText}`}>
                      Welcome to AXPT.
                  </motion.p>
                  <motion.p className={styles.revealText}>
                      Connect with us below:
                  </motion.p>
                  <motion.div className={`${styles.revealText} ${styles.emailContainer}`}>
                      {/* ✅ Sleek Email Icon */}
                ...
                {/* ✅ Vertical Binary Data Stream */}
                <motion.div className={styles.dataStreamContainer}>
                    <motion.div className={styles.binaryLine}>101010 110010 011001 100101</motion.div>
                    <motion.div className={styles.binaryLine}>110011 101000 100110 011011</motion.div>
                    <motion.div className={styles.binaryLine}>100100 110001 101011 010010</motion.div>
                    <motion.div className={styles.binaryLine}>111000 101101 110010 100011</motion.div>
                    <motion.div className={styles.binaryLine}>011110 101010 100100 111101</motion.div>
                    <motion.div className={styles.binaryLine}>110101 011100 100011 101010</motion.div>
                    <motion.div className={styles.binaryLine}>101001 110101 010010 111000</motion.div>
                    <motion.div className={styles.binaryLine}>010101 101110 100011 011010</motion.div>
                    <motion.div className={styles.binaryLine}>110011 100101 011011 101000</motion.div>
                    <motion.div className={styles.binaryLine}>001110 110010 101010 011011</motion.div>
                </motion.div>
                ...
                <motion.div className={styles.smartContractContainer}>
                    ...
                    <motion.div className={styles.signature}>
                        <span className={styles.signatureText}>Verified by AXPT</span>
                    </motion.div>
                </motion.div>
